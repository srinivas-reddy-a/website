...
//                          d = c.read(b);
//                          if (!1 === e && !1 !== d)
//                              return (e = d), (d.conversionName = f), (d.conversion = c), a.BREAK;
//                      }),
//                      a.BREAK
//                  );
//          });
...
// //              var d =
// //                      x && "true" === localStorage.getItem(document.location.href + ".isLocal"),
// //                  e;
...
// //                  ((this.load.remembered = {}), (this.load.remembered.Default = C(this, !0)));
...
// //                              f = e * (1 - c * d);
// //                          d = e * (1 - (1 - c) * d);
// //                          a = [[e, d, b], [f, e, b], [b, e, d], [b, f, e], [d, b, e], [e, b, f]][
// //                              Math.floor(a / 60) % 6
// //                          ];
...
// //                          a =
// //                              (a == b ? (d - e) / c : d == b ? 2 + (e - a) / c : 4 + (a - d) / c) / 6;
// //                          0 > a && (a += 1);
...
//  }
//  //max_radius limit of gravitypoint
//  GravityPoint.RADIUS_LIMIT = 50;
...
//      // Init
//     //  var removediv = document.getElementsByClassName('close-button');
...
//         //  bg.src="./bg.png";
//         //  bg.onload = function(){
//         //      context.drawImage(bg, 0, 0, screenWidth, screenHeight);
//         //  } 
